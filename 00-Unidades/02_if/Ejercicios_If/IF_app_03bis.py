...
---
Enunciado:
A partir del ingreso de la altura de un basquetbolista 
determinar si es pivot o no. 
...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        if altura_jugador > 1.79 :
            mensaje = "Usted puede ser un pivot"
        else :
            mensaje = "Usted no tienes la  altura para ser pivot"
