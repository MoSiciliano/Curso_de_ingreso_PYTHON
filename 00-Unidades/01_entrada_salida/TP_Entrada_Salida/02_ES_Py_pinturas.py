...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        temperatura_f = round((temperatura_c * 9/5) + 32)
        mensaje = f"El valor de {temperatura_c} convertido a Fahrenheit es: {temperatura_f} "
    ...
    def btn_convertir_f_c_on_click(self):
        ...
        mensaje = f"El valor de {temperatura_f} convertido a Centigrados es {temperatura_c}"
